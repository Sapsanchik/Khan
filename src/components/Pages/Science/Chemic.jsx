  ...
  return (
    <div className='flex items-stretch border rounded border-solid flex-row relative justify-start py-8 px-0 mb-4'>
      ...
      <div className="flex m-0 p-0 flex-col relative min-w-0 min-h-0 box-border items-stretch">
        <h2>
          <Link className='text-black' to="chemic">Химия</Link>
        </h2>
        <ul className='ul'>
          <li >
            <Link className='a' to="">Буферы, титриметрический анализ и произведение растворимости</Link>
          </li>
          <li >
            <Link className='a' to="">Органическая химия</Link>
          </li>
          <li >
